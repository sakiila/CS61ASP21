...
def piggy_points(score):
    ...
    "*** YOUR CODE HERE ***"
    temp_res = score ** 2
    min_num = min(int(n) for n in str(temp_res))
    return 3 + min_num
    # END PROBLEM 2
...
def more_boar(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    player_score_str = str(player_score).zfill(2)
    opponent_score_str = str(opponent_score).zfill(2)

    if player_score_str[0] >= opponent_score_str[0] or player_score_str[1] >= opponent_score_str[1]:
        return False
    return True
    # END PROBLEM 4
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        ...
        current_score_diff = current_score - last_score

        if current_score_diff > running_high:
            print("Player", who, "has reached a new maximum point gain.", current_score_diff, "point(s)!")
            return announce_highest(who, current_score, current_score_diff)
